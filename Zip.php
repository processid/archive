...
// -----------------------------------
// -- Renommage des fichiers en double
// -----------------------------------
// Il peut arriver que des fichiers aient le même nom dans un même dossier, ils peuvent être renommés automatiquement en ajoutant -1, -2, -3, ...
// $obj->renameDuplicateFiles = true; // Défault : false
// -----------------------
// -- Ajout de fichiers --
// ----------------------- 
...
class Zip {
    public $zip64;
    public $offsetLocalFileHeader;
    public $sizeCentralDirectory;
    public $nbFiles;
    public $centralDirectoryString;
    public $arrayFiles;
    public $method;
    public $out;
    public $tmpFile;
    public $outFilePointer;
    public $onTheFly;
    public $compressionLevel;
    public $totalFilesize;
    public $renameDuplicateFiles;
    public $arrayRenamedDuplicateFiles;
    public $filename;
    ...
    function __construct($method, $onTheFly, $out, $filename='') {
        ...
        $this->renameDuplicateFiles = false;
        $this->arrayRenamedDuplicateFiles = array();
    }
    ...
    function renameDuplicateFiles() {
        return $this->renameDuplicateFiles;
    }

    function setRenameDuplicateFiles($renameDuplicateFiles) {
    ...
    function addFile($file, $filename='') {
        ...
        if ($this->renameDuplicateFiles()) {
            if (!strlen($filename)) {
                $filename = $file;
            }
            if (array_key_exists($filename,$this->arrayRenamedDuplicateFiles)) {
